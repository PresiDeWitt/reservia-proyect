...
const COLUMN_KEYS: { titleKey: string; links: FooterLink[] }[] = [
  {
...
const SOCIAL: { label: string; href: string; path: string }[] = [
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/reservia.es/',
  ...
  {
    label: 'Podcast',
    href: 'https://open.spotify.com/show/reservia',
    path: 'M12 3a9 9 0 1 0 9 9A9 9 0 0 0 12 3zm0 16a7 7 0 1 1 7-7 7 7 0 0 1-7 7zm1-11h-2v5h2zm0 6h-2v2h2z',
  },
];

const BOTTOM_LINKS: { key: string; to?: string; href?: string }[] = [
  { key: 'footer.privacy', to: '/' },
  { key: 'footer.terms', to: '/' },
  { key: 'footer.contact', href: 'mailto:hola@reservia.es' },
];
  ...
  const handleLinkClick = (link: FooterLink) => {
    if (link.action === '__open_auth_owner') {
      if (isOwnerOrAdmin) {
        ...
        window.location.href = 'mailto:hola@reservia.es?subject=Registro%20de%20Restaurante%20en%20ReserVia';
      }
